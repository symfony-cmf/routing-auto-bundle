...
use Symfony\Cmf\Component\RoutingAuto\AutoRoute\UrlGenerator;
...
class UrlGeneratorTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->driver = $this->prophesize('Symfony\Cmf\Component\RoutingAuto\AutoRoute\Adapter\AdapterInterface');
        $this->serviceRegistry = $this->prophesize('Symfony\Cmf\Component\RoutingAuto\AutoRoute\ServiceRegistry');
        $this->tokenProvider = $this->prophesize('Symfony\Cmf\Component\RoutingAuto\AutoRoute\TokenProviderInterface');
    ...
    public function testGenerateUrl($urlSchema, $expectedUrl, $tokenProviderConfigs)
    {
        ...
        foreach ($tokenProviderConfigs as $tokenName => $tokenProviderConfig) {
            ...
            $this->tokenProviders[$providerName] = $this->prophesize(
                'Symfony\Cmf\Component\RoutingAuto\AutoRoute\TokenProviderInterface'
            );
