...
class UrlContextCollectionTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            $this->{'urlContext' . $i} = $this->prophesize('Symfony\Cmf\Component\RoutingAuto\AutoRoute\UrlContext');
    ...
    public function testCreateUrlContext()
    {
        ...
        $this->assertInstanceOf('Symfony\Cmf\Component\RoutingAuto\AutoRoute\UrlContext', $res);
