...
namespace Symfony\Cmf\Component\RoutingAuto\Tests\Unit\AutoRoute\Mapping;

use Symfony\Cmf\Component\RoutingAuto\AutoRoute\Mapping\ClassMetadata;
...
class MetadataFactoryTest extends BaseTestCase
{
    ...
    {
        $stdClassMetadata = $this->prophet->prophesize('Symfony\Cmf\Component\RoutingAuto\AutoRoute\Mapping\ClassMetadata');
