...
namespace Symfony\Cmf\Component\RoutingAuto\Tests\Unit\AutoRoute\Mapping\Loader;

use Symfony\Cmf\Component\RoutingAuto\AutoRoute\Mapping\Loader\XmlFileLoader;
...
class XmlFileLoaderTest extends BaseTestCase
{
    ...
    public function testCorrectlyParsesValidConfigFiles($file, $check)
    {
        ...
        $this->assertContainsOnlyInstancesOf('Symfony\Cmf\Component\RoutingAuto\AutoRoute\Mapping\ClassMetadata', $result);
        $check($result);
    }
    ...
    public function getCorrectlyParsesValidConfigFilesData()
    {
        ...
        return array(
            ...
            array('valid3.xml', function ($metadatas) use ($test) {
                ...
                $test->assertEquals('Symfony\Cmf\Component\RoutingAuto\CmfRoutingAutoBundle', $metadatas[1]->getClassName());
