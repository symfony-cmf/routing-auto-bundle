...
namespace Symfony\Cmf\Component\RoutingAuto\Tests\Unit\AutoRoute\Adapter;

use Symfony\Cmf\Component\RoutingAuto\Tests\Unit\BaseTestCase;
use Symfony\Cmf\Component\RoutingAuto\AutoRoute\Adapter\PhpcrOdmAdapter;
...
class PhpcrOdmAdapterTest extends BaseTestCase
{
    ...
    public function testCreateAutoRoute($path, $expectedParentPath, $expectedName, $parentPathExists)
    {
        ...
        $this->assertInstanceOf('Symfony\Cmf\Component\RoutingAuto\Model\AutoRoute', $res);
