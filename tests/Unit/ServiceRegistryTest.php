...
class ServiceRegistryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->tokenProvider = $this->getMock('Symfony\Cmf\Component\RoutingAuto\AutoRoute\TokenProviderInterface');
        $this->conflictResolver = $this->getMock('Symfony\Cmf\Component\RoutingAuto\AutoRoute\ConflictResolverInterface');
