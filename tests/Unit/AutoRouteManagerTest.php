...
namespace Symfony\Cmf\Component\RoutingAuto\Tests\Unit\AutoRoute;

use Symfony\Cmf\Component\RoutingAuto\AutoRoute\AutoRouteManager;
...
class AutoRouteManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->driver = $this->getMock('Symfony\Cmf\Component\RoutingAuto\AutoRoute\Adapter\AdapterInterface');
        $this->urlGenerator = $this->getMock('Symfony\Cmf\Component\RoutingAuto\AutoRoute\UrlGeneratorInterface');
        $this->defunctRouteHandler = $this->getMock('Symfony\Cmf\Component\RoutingAuto\AutoRoute\DefunctRouteHandlerInterface');
