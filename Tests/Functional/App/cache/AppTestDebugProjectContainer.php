...
class AppTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('cmf_routing.router')), 2 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 3 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine_phpcr'))));
    }
    ...
    protected function getCmfRouting_RouterService()
    {
        ...
        $this->services['cmf_routing.router'] = $instance = new \Symfony\Cmf\Component\Routing\ChainRouter(NULL);

        $instance->setContext($a);
        $instance->add(new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/config/routing.php', array('cache_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'AppTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'AppTestUrlMatcher', 'strict_requirements' => true), $a, NULL), 100);

        return $instance;
    }

    /**
     * Gets the 'cmf_routing.terms_form_type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingBundle\Form\Type\TermsFormType A Symfony\Cmf\Bundle\RoutingBundle\Form\Type\TermsFormType instance.
     */
    protected function getCmfRouting_TermsFormTypeService()
    {
        return $this->services['cmf_routing.terms_form_type'] = new \Symfony\Cmf\Bundle\RoutingBundle\Form\Type\TermsFormType($this->get('cmf_routing.router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\AutoRouteManager A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\AutoRouteManager instance.
     */
    protected function getCmfRoutingAuto_AutoRouteManagerService()
    {
        return $this->services['cmf_routing_auto.auto_route_manager'] = new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\AutoRouteManager($this->get('cmf_routing_auto.factory'), $this->get('cmf_routing_auto.route_stack_builder'));
    }

    /**
     * Gets the 'cmf_routing_auto.exists_action.auto_increment' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\AutoIncrementPath A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\AutoIncrementPath instance.
     */
    protected function getCmfRoutingAuto_ExistsAction_AutoIncrementService()
    {
        $a = $this->get('doctrine_phpcr.odm.default_document_manager');

        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\AutoIncrementPath($a, new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\DefaultMaker(new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker($a), new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker($a)));
    }

    /**
     * Gets the 'cmf_routing_auto.exists_action.use' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\UsePath A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\UsePath instance.
     */
    protected function getCmfRoutingAuto_ExistsAction_UseService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathExists\UsePath($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\Factory A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\Factory instance.
     */
    protected function getCmfRoutingAuto_FactoryService()
    {
        $this->services['cmf_routing_auto.factory'] = $instance = new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\Factory($this, $this->get('cmf_routing_auto.route_stack_builder'));

        $instance->registerMapping('Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\Tests\\Functional\\app\\Document\\Blog', array('content_path' => array('base' => array('provider' => array('name' => 'specified', 'path' => 'test/auto-route'), 'exists_action' => array('strategy' => 'use'), 'not_exists_action' => array('strategy' => 'create')), 'namespace' => array('provider' => array('name' => 'specified', 'path' => 'blog'), 'exists_action' => array('strategy' => 'use'), 'not_exists_action' => array('strategy' => 'create'))), 'content_name' => array('provider' => array('name' => 'content_method', 'method' => 'getTitle'), 'exists_action' => array('strategy' => 'auto_increment', 'pattern' => '-%d'), 'not_exists_action' => array('strategy' => 'create'))));
        $instance->registerMapping('Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\Tests\\Functional\\app\\Document\\Post', array('content_path' => array('blog_path' => array('provider' => array('name' => 'content_object', 'method' => 'getBlog'), 'exists_action' => array('strategy' => 'use'), 'not_exists_action' => array('strategy' => 'throw_exception')), 'date' => array('provider' => array('name' => 'content_datetime', 'method' => 'getDate', 'date_format' => 'Y/m/d'), 'exists_action' => array('strategy' => 'use'), 'not_exists_action' => array('strategy' => 'create'))), 'content_name' => array('provider' => array('name' => 'content_method', 'method' => 'getTitle'), 'exists_action' => array('strategy' => 'auto_increment', 'pattern' => '-%d'), 'not_exists_action' => array('strategy' => 'create'))));
        $instance->registerAlias('provider', 'specified', 'cmf_routing_auto.path_provider.specified');
        $instance->registerAlias('provider', 'content_method', 'cmf_routing_auto.path_provider.content_method');
        $instance->registerAlias('provider', 'content_datetime', 'cmf_routing_auto.path_provider.content_datetime');
        $instance->registerAlias('provider', 'content_object', 'cmf_routing_auto.path_provider.content_object');
        $instance->registerAlias('exists_action', 'use', 'cmf_routing_auto.exists_action.use');
        $instance->registerAlias('exists_action', 'auto_increment', 'cmf_routing_auto.exists_action.auto_increment');
        $instance->registerAlias('not_exists_action', 'throw_exception', 'cmf_routing_auto.not_exists_action.throw_exception');
        $instance->registerAlias('not_exists_action', 'create', 'cmf_routing_auto.not_exists_action.create');
        $instance->registerAlias('route_maker', 'default', 'cmf_routing_auto.route_maker.default');
        $instance->registerAlias('route_maker', 'auto_route', 'cmf_routing_auto.route_maker.auto_route');
        $instance->registerAlias('route_maker', 'generic', 'cmf_routing_auto.route_maker.generic');
        $instance->registerAlias('route_maker', 'route', 'cmf_routing_auto.route_maker.route');

        return $instance;
    }

    /**
     * Gets the 'cmf_routing_auto.not_exists_action.create' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\CreatePath A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\CreatePath instance.
     */
    protected function getCmfRoutingAuto_NotExistsAction_CreateService()
    {
        $a = $this->get('doctrine_phpcr.odm.default_document_manager');

        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\CreatePath(new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\DefaultMaker(new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker($a), new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker($a)));
    }

    /**
     * Gets the 'cmf_routing_auto.not_exists_action.throw_exception' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\ThrowException A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\ThrowException instance.
     */
    protected function getCmfRoutingAuto_NotExistsAction_ThrowExceptionService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathNotExists\ThrowException();
    }

    /**
     * Gets the 'cmf_routing_auto.path_provider.content_datetime' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentDateTimeProvider A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentDateTimeProvider instance.
     */
    protected function getCmfRoutingAuto_PathProvider_ContentDatetimeService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentDateTimeProvider($this->get('cmf_routing_auto.slugifier'));
    }

    /**
     * Gets the 'cmf_routing_auto.path_provider.content_method' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentMethodProvider A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentMethodProvider instance.
     */
    protected function getCmfRoutingAuto_PathProvider_ContentMethodService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentMethodProvider($this->get('cmf_routing_auto.slugifier'));
    }

    /**
     * Gets the 'cmf_routing_auto.path_provider.content_object' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentObjectProvider A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentObjectProvider instance.
     */
    protected function getCmfRoutingAuto_PathProvider_ContentObjectService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\ContentObjectProvider($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.path_provider.specified' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\SpecifiedProvider A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\SpecifiedProvider instance.
     */
    protected function getCmfRoutingAuto_PathProvider_SpecifiedService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\PathProvider\SpecifiedProvider();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\EventListener\AutoRouteListener A Symfony\Cmf\Bundle\RoutingAutoBundle\EventListener\AutoRouteListener instance.
     */
    protected function getCmfRoutingAuto_PhpcrodmAutoRouteListenerService()
    {
        return $this->services['cmf_routing_auto.phpcrodm_auto_route_listener'] = new \Symfony\Cmf\Bundle\RoutingAutoBundle\EventListener\AutoRouteListener($this);
    }

    /**
     * Gets the 'cmf_routing_auto.route_maker.auto_route' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker instance.
     */
    protected function getCmfRoutingAuto_RouteMaker_AutoRouteService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.route_maker.default' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\DefaultMaker A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\DefaultMaker instance.
     */
    protected function getCmfRoutingAuto_RouteMaker_DefaultService()
    {
        $a = $this->get('doctrine_phpcr.odm.default_document_manager');

        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\DefaultMaker(new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\AutoRouteMaker($a), new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker($a));
    }

    /**
     * Gets the 'cmf_routing_auto.route_maker.generic' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker instance.
     */
    protected function getCmfRoutingAuto_RouteMaker_GenericService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\GenericMaker($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.route_maker.route' service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\RouteMaker A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\RouteMaker instance.
     */
    protected function getCmfRoutingAuto_RouteMaker_RouteService()
    {
        return new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteMaker\RouteMaker($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.route_patcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RoutePatcher\GenericPatcher A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RoutePatcher\GenericPatcher instance.
     */
    protected function getCmfRoutingAuto_RoutePatcherService()
    {
        return $this->services['cmf_routing_auto.route_patcher'] = new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RoutePatcher\GenericPatcher($this->get('doctrine_phpcr.odm.default_document_manager'));
    }

    /**
     * Gets the 'cmf_routing_auto.route_stack_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteStack\Builder A Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteStack\Builder instance.
     */
    protected function getCmfRoutingAuto_RouteStackBuilderService()
    {
        return $this->services['cmf_routing_auto.route_stack_builder'] = new \Symfony\Cmf\Bundle\RoutingAutoBundle\AutoRoute\RouteStack\Builder($this->get('doctrine_phpcr.odm.default_document_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('charset' => 'UTF8', 'path' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/app.sqlite', 'driver' => 'pdo_sqlite', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrinePhpcr_Odm_DefaultDocumentManagerService()
    {
        ...
        $b->setNamespace('sf2phpcr_default_0f522e5a16e9e246f30c510b0d209445');

        $c = new \Doctrine\ODM\PHPCR\Mapping\Driver\AnnotationDriver($a, array(0 => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/Document', 1 => '/home/daniel/www/RoutingAutoBundle/vendor/doctrine/phpcr-odm/lib/Doctrine/ODM/PHPCR/Document'));

        $d = new \Doctrine\Bundle\PHPCRBundle\Mapping\Driver\XmlDriver(array('/home/daniel/www/RoutingAutoBundle/vendor/symfony-cmf/routing-bundle/Symfony/Cmf/Bundle/RoutingBundle/Resources/config/doctrine' => 'Symfony\\Cmf\\Bundle\\RoutingBundle\\Document', '/home/daniel/www/RoutingAutoBundle/Resources/config/doctrine' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\Document'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $e->addDriver($c, '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/Document');
        $e->addDriver($c, 'Doctrine\\ODM\\PHPCR\\Document');
        $e->addDriver($d, 'Symfony\\Cmf\\Bundle\\RoutingBundle\\Document');
        $e->addDriver($d, 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\Document');

        $f = new \Doctrine\ODM\PHPCR\Configuration();
        $f->setDocumentNamespaces(array('test' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/Document', '__PHPCRODM__' => 'Doctrine\\ODM\\PHPCR\\Document', 'CmfRoutingBundle' => 'Symfony\\Cmf\\Bundle\\RoutingBundle\\Document', 'CmfRoutingAutoBundle' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\Document'));
        $f->setMetadataCacheImpl($b);
        $f->setMetadataDriverImpl($e, false);
        $f->setProxyDir('/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/doctrine/PHPCRProxies');
        ...
        $g->addEventListener(array(0 => 'onFlush'), $this->get('cmf_routing_auto.phpcrodm_auto_route_listener'));
    ...
    {
        return $this->services['doctrine_phpcr.odm.locale_chooser'] = new \Doctrine\ODM\PHPCR\Translation\LocaleChooser\LocaleChooser(array('en' => array(0 => 'de', 1 => 'fr'), 'de' => array(0 => 'en', 1 => 'fr'), 'fr' => array(0 => 'en', 1 => 'de')), 'en');
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'test');
    }
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('field' => 'form.type.field', 'form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'phpcr_reference' => 'form.type.phpcr.reference', 'phpcr_odm_reference_collection' => 'form.type.phpcr_odm.reference_collection', 'phpcr_document' => 'form.type.phpcr.document', 'phpcr_odm_image' => 'doctrine_phpcr.odm.form.type.image', 'phpcr_odm_path' => 'doctrine_phpcr.odm.form.type.path', 'cmf_routing_terms_form_type' => 'cmf_routing.terms_form_type', 'cmf_routing_route_type' => 'cmf_routing.route_type_form_type'), array('form' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.csrf'), 'repeated' => array(0 => 'form.type_extension.repeated.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine_phpcr'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener('en', $this->get('cmf_routing.router'));
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/profiler', '', '', 86400), NULL);
    ...
    {
        return $this->services['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener($this->get('cmf_routing.router'), $this->get('router.request_context'), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = new \Symfony\Component\Security\Http\EntryPoint\BasicAuthenticationEntryPoint('Secured Demo Area');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($d, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), NULL), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'main', NULL, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $b, 'main', $e, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '51a11a1332d63', NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($a, $this->get('security.access.decision_manager'), $d, $b, NULL)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($c, $c), 'main', $e, NULL, NULL, NULL));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/secure_random.seed', NULL);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'CmfRoutingBundle:Form:terms_form_type.html.twig')), $this->get('form.csrf_provider'))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/doctrine/phpcr-bundle/Doctrine/Bundle/PHPCRBundle/Resources/views', 'DoctrinePHPCR');
        $instance->addPath('/home/daniel/www/RoutingAutoBundle/vendor/symfony-cmf/routing-bundle/Symfony/Cmf/Bundle/RoutingBundle/Resources/views', 'CmfRouting');
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('security.validator.user_password' => 'security.validator.user_password', 'doctrine_phpcr.odm.validator.valid_phpcr_odm' => 'doctrine_phpcr.odm.validator.valid_phpcr_odm')), $this->get('translator.default'), 'validators', array());
    }
     ...
     *
     * @return Symfony\Cmf\Component\Routing\ChainRouter An instance of the cmf_routing.router service
     */
    protected function getRouterService()
    {
        return $this->get('cmf_routing.router');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/home/daniel/www/RoutingAutoBundle/vendor/symfony-cmf/routing-bundle/Symfony/Cmf/Bundle/RoutingBundle/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'App',
            'kernel.cache_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache',
            'kernel.logs_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/logs',
            ...
            'database_path' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/app.sqlite',
            'locale' => 'en',
            ...
            'debug.container.dump' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/AppTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/daniel/www/RoutingAutoBundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/home/daniel/www/RoutingAutoBundle/vendor/symfony-cmf/routing-bundle/Symfony/Cmf/Bundle/RoutingBundle/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/profiler',
            ...
            'router.resource' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/config/routing.php',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'CmfRoutingBundle:Form:terms_form_type.html.twig',
            ),
            'twig.options' => array(
                'debug' => true,
                'strict_variables' => true,
                'exception_controller' => 'twig.controller.exception:showAction',
                'cache' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'doctrine_phpcr.odm.locale_chooser.class' => 'Doctrine\\ODM\\PHPCR\\Translation\\LocaleChooser\\LocaleChooser',
            ...
            'doctrine_phpcr.odm.default_locale' => 'en',
            ...
            'doctrine_phpcr.odm.proxy_dir' => '/home/daniel/www/RoutingAutoBundle/Tests/Functional/App/cache/doctrine/PHPCRProxies',
            'doctrine_phpcr.odm.proxy_namespace' => 'PHPCRProxies',
            'cmf_routing.chain_router_class' => 'Symfony\\Cmf\\Component\\Routing\\ChainRouter',
            'cmf_routing.replace_symfony_router' => true,
            'cmf_routing.route_type_type_class' => 'Symfony\\Cmf\\Bundle\\RoutingBundle\\Form\\Type\\RouteTypeType',
            'cmf_routing.terms_form_type_class' => 'Symfony\\Cmf\\Bundle\\RoutingBundle\\Form\\Type\\TermsFormType',
            'cmf_routing_auto.phpcrodm_auto_route_listener_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\EventListener\\AutoRouteListener',
            'cmf_routing_auto.auto_route_manager_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\AutoRouteManager',
            'cmf_routing_auto.factory_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\Factory',
            'cmf_routing_auto.route_stack_builder_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RouteStack\\Builder',
            'cmf_routing_auto.route_patcher_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RoutePatcher\\GenericPatcher',
            'cmf_routing_auto.provider.specified_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathProvider\\SpecifiedProvider',
            'cmf_routing_auto.provider.content_method_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathProvider\\ContentMethodProvider',
            'cmf_routing_auto.provider.content_object_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathProvider\\ContentObjectProvider',
            'cmf_routing_auto.provider.content_datetime_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathProvider\\ContentDateTimeProvider',
            'cmf_routing_auto.exists_action.use_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathExists\\UsePath',
            'cmf_routing_auto.exists_action.auto_increment_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathExists\\AutoIncrementPath',
            'cmf_routing_auto.not_exists_action.throw_exception_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathNotExists\\ThrowException',
            'cmf_routing_auto.not_exists_action.create_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\PathNotExists\\CreatePath',
            'cmf_routing_auto.route_maker.default_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RouteMaker\\DefaultMaker',
            'cmf_routing_auto.route_maker.auto_route_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RouteMaker\\AutoRouteMaker',
            'cmf_routing_auto.route_maker.generic_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RouteMaker\\GenericMaker',
            'cmf_routing_auto.route_maker.route_class' => 'Symfony\\Cmf\\Bundle\\RoutingAutoBundle\\AutoRoute\\RouteMaker\\RouteMaker',
